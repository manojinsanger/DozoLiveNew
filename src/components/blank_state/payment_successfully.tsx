  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require("../../assets/images/blank_state/payment_successfully.png")} // Update with the correct file name
          style={styles.image}
          resizeMode="contain"
        />
      </View>
      ...
      {/* Text Content */}
      <Text style={[styles.title, { fontFamily: "DM-Sans" }]}>Payment successfully</Text>
