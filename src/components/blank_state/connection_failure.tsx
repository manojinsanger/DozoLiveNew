  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require("../../assets/images/blank_state/connection_failure.png")} // Update with the correct file name
          style={styles.image}
          resizeMode="contain"
        />
      </View>
      ...
      {/* Text Content */}
      <Text style={[styles.title, { fontFamily: "DM-Sans" }]}>Network connection failure</Text>
